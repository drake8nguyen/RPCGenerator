...
main(int argc, char *argv[]) {
     ...
     //
     setUpDebugLogging("SwitchName.txt",argc, argv);
     ...
     try {
       ...
       //
       printf("Switch name Drake Nguyen\n");
       switchName(p);                          // remote call (we hope!)
       printf("Returned from switchName. FirstName=%s LastName =%s\n", p.firstname.c_str(), p.lastname.c_str());
